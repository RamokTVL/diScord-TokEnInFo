...
const nitro = {
    0: "Sans Discord Nitro",
    1: "Discord Nitro Classique",
    2: "Discord Nitro Boost"
}
...
function getInfos(token) {
    ...
    if (token.match(/mfa.[\w-]{84}/g) || token.match(/[MN][A-Za-z\d]{23}\.[\w-]{6}\.[\w-]{27}/g)) {
        ...
        return console.log('\x1b[31mIl vous faut mettre un token!\x1b[0m')
    }
}
